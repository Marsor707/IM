...
import com.example.marsor.push.frags.group.GroupMemberAddFragment;

import butterknife.BindView;
import butterknife.OnClick;

public class GroupMemberActivity extends PresenterToolbarActivity<GroupMembersContract.Presenter> implements GroupMembersContract.View,GroupMemberAddFragment.Callback {
    ...
    class ViewHolder extends RecyclerAdapter.ViewHolder<MemberUserModel> {
        ...
        void onPortraitClick() {
            PersonalActivity.show(GroupMemberActivity.this, mData.id);
        }
    }
}
